...
public class Bot {
    ...
    private static void addCommands(CommandClientBuilder clientBuilder) {
        // commands here
        clientBuilder.addSlashCommands(new RegisterCommand(), new ContactCommand(), new BalancesCommand(),
                new AddCurrencyCommand(), new BalanceCommand(), new LoanCommand(), new DeleteAccountCommand());
    }
}